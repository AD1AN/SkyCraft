...
struct FItemProperty
{
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite) TArray<FString> Strings;
	UPROPERTY(EditAnywhere, BlueprintReadWrite) TArray<FInventorySlotNested> NestedInventorySlots;
	UPROPERTY(EditAnywhere, BlueprintReadWrite) TArray<class UDA_Item*> Items;
};