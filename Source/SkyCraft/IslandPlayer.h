...
#include "IslandPlayer.generated.h"
...
class SKYCRAFT_API AIslandPlayer : public AIsland, public IEssenceInterface
{
	GENERATED_BODY()
...
public:
	...
	UPROPERTY(Replicated, BlueprintReadOnly) APawnIslandControl* PawnIslandControl = nullptr;
